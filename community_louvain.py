...
def induced_graph(partition, graph, weight="weight"):
    ...
    for node1, node2, datas in graph.edges(data=True):
        ...
        # Addition kwuellems 12.09.2019 #
        try:
            new_count = ret.get_edge_data(com1, com2, {"count": 0}).get("count", 1) + 1
        except:
            new_count = 1
        ###
        w_prec = ret.get_edge_data(com1, com2, {weight: 0}).get(weight, 1)
        # Addition kwuellems 12.09.2019 #
        ret.add_edge(com1, com2, **{weight: w_prec + edge_weight, "count": new_count})
        ###
    # Addition kwuellems 12.09.2019 #
    d = w_prec/new_count
    ###
